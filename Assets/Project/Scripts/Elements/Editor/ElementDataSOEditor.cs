...
namespace AgaveCase.Elements.Editor
{
    ...
    public class ElementDataSOEditor : UnityEditor.Editor
    {
        ...
        private SerializedProperty _pointValueProp;  
        private SerializedProperty _elementPoolTypeSoProp;
        private SerializedProperty _destroyPoolTypeSoProp;
        ...
        private void OnEnable()
        {
            ...
            _pointValueProp = serializedObject.FindProperty("_pointValue");  
            _elementPoolTypeSoProp = serializedObject.FindProperty("_elementPoolTypeSo");
            _destroyPoolTypeSoProp = serializedObject.FindProperty("_destroyPoolTypeSo");
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(_pointValueProp, new GUIContent("Point Value"));
            
            EditorGUILayout.Space(10);
            EditorGUILayout.LabelField("Pool Settings", EditorStyles.boldLabel);
            EditorGUILayout.PropertyField(_elementPoolTypeSoProp, new GUIContent("Element Pool Type"));
            EditorGUILayout.PropertyField(_destroyPoolTypeSoProp, new GUIContent("Destroy Effect Pool Type"));
